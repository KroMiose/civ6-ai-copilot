...
When upgrading from `0.1.x` to the 0.3 protocol, update the Mod, Skill, and local tools together. Old snapshots cannot be used with the 0.3 protocol. `0.3.4` updates the Agent Skill and local tools only; an installed `0.3.1` Mod can stay in the game.
...
Current pre-release version: `0.3.4`.
